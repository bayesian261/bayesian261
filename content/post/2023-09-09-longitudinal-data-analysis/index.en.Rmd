...
```{r rstudio-id, fig.cap="The RStudio IDE", fig.align="center", echo = FALSE, out.width = if (knitr::is_latex_output()) {"65%"}}
...
#
```{r rstudio-i, fig.cap="The RStudio IDE", fig.align="center", echo = FALSE, out.width = if (knitr::is_latex_output()) {"65%"}}
...
# Matrix D
```{r rstudio, fig.cap="The RStudio IDE", fig.align="center", echo = FALSE, out.width = if (knitr::is_latex_output()) {"65%"}}
knitr::include_graphics('new1.png')
```

# Matrix R
```{r rstudiide, fig.cap="The RStudio IDE", fig.align="center", echo = FALSE, out.width = if (knitr::is_latex_output()) {"65%"}}
knitr::include_graphics('new_r.png')
```

# contrasting with the general linear model
```{r rstudide, fig.cap="The RStudio IDE", fig.align="center", echo = FALSE, out.width = if (knitr::is_latex_output()) {"65%"}}
knitr::include_graphics('new_p.png')
```

# cont'd
```{r rstu-ide, fig.cap="The RStudio IDE", fig.align="center", echo = FALSE, out.width = if (knitr::is_latex_output()) {"65%"}}
